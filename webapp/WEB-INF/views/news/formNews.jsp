...
<body>
	...
	<div class="container theme-showcase" role="main">
		...
		<form:form action="${urlForm}" method="post" enctype="multipart/form-data" modelAttribute="news">
			<div class="row">
				<div class="col-sm-6">
				...
				<div class="col-sm-3">
					<div class="form-group">
						<label for="status">Estatus</label> <form:select id="status"
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="form-group">
						...
						<form:textarea class="form-control" path="detail" id="detail" rows="10"></form:textarea>
					</div>
				</div>
			</div>
