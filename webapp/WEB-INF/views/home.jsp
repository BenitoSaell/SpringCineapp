			...
			<div class="col-lg-12">
				...
				<form class="form-inline" action="${urlRoot}search" method="post">
					<div class="form-group">
						<label for="dateF">Fecha: </label> <select id="dateF" name="dateF"
							class="form-control">
							<c:forEach items="${dateList}" var="date">
								<c:choose>
									<c:when test="${dateSearch==date}">
				...
				<c:forEach items="${movies}" var="movie">
					<div class="col-xs-12 col-sm-6 col-md-3">
						...
						<h4>
							...
							<span class="label label-default">${movie.duration } min</span> <span
								class="label label-default">${movie.gender }</span>
						</h4>
						<p>
							<a class="btn btn-sm btn-primary" href="detail/${movie.id }/${dateSearch}" role="button">Consulta
								Horarios &raquo;</a>
							<%--a class="btn btn-sm btn-primary"
								href="detail?idMovie=${movie.id }&dateSearch=${dateSearch}"
					...
					<c:forEach items="${listNews}" var="news">
						<div class="blog-post">
							...
							<p class="blog-post-meta">
								<span class="label label-danger">Publicado: <fmt:formatDate value="${news.date}" pattern="dd-MM-yyyy"/></span>
							</p>
							<p>
								${news.detail }
							</p>
